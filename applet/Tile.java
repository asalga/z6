...
PImage water =   loadImage(path + "water.png");
  ...
  PImage getImage(){
    switch(id){
      case Constants.GRASS: return grass;
      case Constants.WATER: return water;
      case Constants.TREES: return trees;
      case Constants.CLOUD1: return cloud1;
      case Constants.CLOUD2: return cloud2;
      case Constants.SHIP:   return ship;
    }
    return null;
  }
}